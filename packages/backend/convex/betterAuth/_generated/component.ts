...
export type ComponentApi<Name extends string | undefined = string | undefined> = {
  adapter: {
    ...
    findMany: FunctionReference<
      ...
      "internal",
      {
        join?: any;
        limit?: number;
        model: "user" | "session" | "account" | "verification" | "jwks" | "deviceCode";
        offset?: number;
        paginationOpts: {
          cursor: string | null;
          endCursor?: string | null;
  ...
  deviceAuth: {
    approveDeviceCode: FunctionReference<
      ...
      Name
    >;
    denyDeviceCode: FunctionReference<"mutation", "internal", { user_code: string }, any, Name>;
    getDeviceCodeInfo: FunctionReference<"query", "internal", { user_code: string }, any, Name>;
    pollDeviceToken: FunctionReference<"mutation", "internal", { device_code: string }, any, Name>;
