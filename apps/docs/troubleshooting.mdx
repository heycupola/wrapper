...
3. Check that `WRAPPER_DISABLE` is unset if you expected the optional rc hook.
...
Upgrade to Pro ($99/year or $15/month) to attach from another device. Attach
from the same computer remains available without Pro. See [Pricing](/reference/pricing).
