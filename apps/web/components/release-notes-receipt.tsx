...
export const RELEASE_NOTES_COPY: Record<
...
/** Result card for confirm/unsubscribe. Safe in client trees. */
export function ReleaseNotesReceipt({ variant }: { variant: ReleaseNotesMomentVariant }) {
